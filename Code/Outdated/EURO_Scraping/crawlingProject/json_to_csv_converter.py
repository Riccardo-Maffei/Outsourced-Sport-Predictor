...
PATH_TO_JSON = 'spiders/output.json'

PATH_TO_COMPLETE_CSV = '../../../../Data/Outdated/DataTables/Complete Dataset.csv'
PATH_TO_FILTERED_CSV = '../../../../Data/Outdated/DataTables/Filtered Dataset.csv'
