...
clubs_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/clubs.csv')
competitions_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/competitions.csv')
club_games_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/club_games.csv')
game_events_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/game_events.csv')
games_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/games.csv')
player_valuations_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/player_valuations.csv')
players_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/players.csv')
appearances_df = pd.read_csv('../../../Data/Data_Bank/Transfermarket/appearances.csv')
